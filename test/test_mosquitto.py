...
START_PUBLICATIONS = [
    ...
    (
        ...
        '{"type": "value", "readonly": true, "units": "tasks", "min": 0}',
    ),
    ...
    (
        ...
        '{"type": "value", "readonly": true, "units": "MiB", "min": 0}',
    ),
    ...
    ("/devices/device/controls/dev_root_linked_on/meta", '{"type": "text", "readonly": true}'),
